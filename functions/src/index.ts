...
- "searchTerms": a concise array of 4-8 search terms for the specific inventory items in this photo. Rules strictly enforced: (1) name only objects that are being stored, not the container, shelving, floor, wall, room, or background surfaces; (2) use the most specific item name first, then add only genuinely useful alternate names, synonyms, informal names, or plurals; (3) do not include generic placeholders such as "box", "bin", "shelf", "wall", "floor", "room", "misc", "stuff", "items", "things", "storage", "organization", "household", or "workshop"; (4) do not add broad conceptual or thematic terms unless they are the actual object category someone would search for; (5) each term should be something a person would type into eBay, Facebook Marketplace, or a home inventory app to find that specific object; (6) fewer precise terms are better than more vague terms.
