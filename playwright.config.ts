...
const useSparticuzChromium = process.env.VOWVY_USE_SPARTICUZ_CHROMIUM === 'true';

const localChromiumPath = useSparticuzChromium
  ? await inflate(join(
      process.cwd(),
...
export default defineConfig({
  ...
  use: {
    ...
    channel: localChromiumPath ? undefined : 'chromium',
